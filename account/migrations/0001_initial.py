    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pin', models.CharField(max_length=4, validators=[account.validator.validate_pin])),
                ('balance', models.DecimalField(decimal_places=2, default=0.0, max_digits=15)),
                ('account_type', models.CharField(choices=[('SAV', 'SAVING'), ('CUR', 'CURRENT'), ('DOM', 'DOMICILIARY')], default='SAV', max_length=3)),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
